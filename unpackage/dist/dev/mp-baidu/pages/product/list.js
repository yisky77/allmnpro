...
var _list = _interopRequireDefault(__webpack_require__(/*! ./pages/product/list.vue */ 352));
...
/* harmony import */ var _list_vue_vue_type_template_id_1fe0e498___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./list.vue?vue&type=template&id=1fe0e498& */ 353);
...
/* harmony import */ var _list_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./list.vue?vue&type=style&index=0&lang=scss& */ 357);
...
var render = function() {
  ...
  return _c("view", { staticClass: "content", attrs: { _hid: 0 } }, [
    _c(
      "view",
      { staticClass: "mp-search-box", attrs: { _hid: 1 } },
      [
        _c(
          "navigator",
          {
            staticClass: "ser-input",
            attrs: { type: "text", url: "/pages/product/searchlist", _hid: 2 }
          },
          []
        )
      ],
    ...
    _c(
      "view",
      { staticClass: "goods-list", attrs: { _hid: 4 } },
      _vm._l(
        _vm.goodsList,
        function(item, index, item_i2) {
          ...
          return _c(
            ...
            [
              ...
              _c(
                "text",
                { staticClass: "title clamp", attrs: { _hid: 8, _fid: _fid } },
                [_vm._v(_vm._s(item.name), 9, _fid)]
              ),
              _c(
                "view",
                { staticClass: "price-box", attrs: { _hid: 10, _fid: _fid } },
                [
                  _c(
                    "text",
                  ...
                  _c("text", { attrs: { _hid: 13, _fid: _fid } }, [
                    _vm._v("原价 " + _vm._s(item.counterPrice), 14, _fid)
                  ])
                ]
              )
            ]
    ...
    _vm._ri(!!(!_vm.loadModal && _vm.goodsList.length <= 0), 15)
      ? _c(
          "view",
          {
              ...
              _vm._l(
                ...
                function(item, item_i1, item_i2) {
                  ...
                  return _c(
                    ...
                    {
                      key: item.id,
                      attrs: { _hid: 23, _fid: _fid, _fk: "id" }
                    },
                    [
                      _c(
                        "view",
                        ...
                        [_vm._v(_vm._s(item.name), 25, _fid)]
                      ),
                      _vm._l(
                        item.child,
                        function(tItem, tItem_i1, tItem_i2) {
                          ...
                          return _c(
                            "view",
                            {
                              ...
                              attrs: { _hid: 26, _fid: _fid, _fk: "id" },
                              on: {
                                click: function($event) {
                            ...
                            [_vm._v(_vm._s(tItem.name), 27, _fid)]
                          )
                        },
                        26 + "_" + (item_i2 !== undefined ? item_i2 : item_i1),
                        _vm._self
                      )
                    ],
                    1
