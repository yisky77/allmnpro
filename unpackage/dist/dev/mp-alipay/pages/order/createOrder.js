(my["webpackJsonp"] = my["webpackJsonp"] || []).push([["pages/order/createOrder"],{
...
var _createOrder = _interopRequireDefault(__webpack_require__(/*! ./pages/order/createOrder.vue */ 291));
...
/* harmony import */ var _createOrder_vue_vue_type_template_id_b474e2f2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createOrder.vue?vue&type=template&id=b474e2f2& */ 292);
/* harmony import */ var _createOrder_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createOrder.vue?vue&type=script&lang=js& */ 294);
...
/* harmony import */ var _createOrder_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./createOrder.vue?vue&type=style&index=0&lang=scss& */ 296);
...
var render = function() {
  ...
  return _c("view", { attrs: { _hid: 0 } }, [
          ...
          _c("view", { staticClass: "cen", attrs: { _hid: 4 } }, [
            _c("view", { staticClass: "top", attrs: { _hid: 5 } }, [
              _c("text", { staticClass: "name", attrs: { _hid: 6 } }, [
                _vm._v(
                  _vm._s(
                    _vm.checkedAddress.name == undefined
                      ? "请选择地址"
                      : _vm.checkedAddress.name
                  ),
                  7
                )
              ]),
            ...
            _c("text", { staticClass: "address", attrs: { _hid: 10 } }, [
              _vm._v(_vm._s(_vm.checkedAddress.addressDetail), 11)
            ])
          ]),
    ...
    _c("view", { staticClass: "yt-list", attrs: { _hid: 43 } }, [
      _c("view", { staticClass: "yt-list-cell b-b", attrs: { _hid: 44 } }, [
        _c("text", { staticClass: "cell-tit clamp", attrs: { _hid: 45 } }, [
          _vm._ri(!!(_vm.goods.grouponPrice > 0), 47)
            ? _c("text", { staticClass: "cell-tip", attrs: { _hid: 47 } }, [])
            : _vm._e()
        ]),
        _c("text", { staticClass: "cell-tip", attrs: { _hid: 49 } }, [
          _vm._v("￥" + _vm._s(_vm.goods.goodsTotalPrice), 50)
        ])
      ]),
      _c("view", { staticClass: "yt-list-cell b-b", attrs: { _hid: 51 } }, [
        _c("text", { staticClass: "cell-tit clamp", attrs: { _hid: 52 } }, []),
        _c("text", { staticClass: "cell-tip red", attrs: { _hid: 54 } }, [
          _vm._v("-￥" + _vm._s(_vm.goods.couponPrice), 55)
        ])
      ]),
      _c("view", { staticClass: "yt-list-cell b-b", attrs: { _hid: 56 } }, [
        _c("text", { staticClass: "cell-tit clamp", attrs: { _hid: 57 } }, [
          _vm._v(
            "运费" + _vm._s(_vm.goods.freightPrice == 0 ? "(已包邮)" : ""),
            58
          )
        ]),
        _c("text", { staticClass: "cell-tip", attrs: { _hid: 59 } }, [
          _vm._v(_vm._s(_vm.goods.freightPrice), 60)
        ])
      ]),
      _c(
        "view",
        { staticClass: "yt-list-cell desc-cell", attrs: { _hid: 61 } },
        [
          _c(
            "text",
            { staticClass: "cell-tit clamp", attrs: { _hid: 62 } },
            []
          ),
          _c("input", {
            directives: [
    ...
    _c("view", { staticClass: "footer", attrs: { _hid: 65 } }, [
      _c("view", { staticClass: "price-content", attrs: { _hid: 66 } }, [
        _c("text", { attrs: { _hid: 67 } }, []),
        _c("text", { staticClass: "price-tip", attrs: { _hid: 69 } }, []),
        _c("text", { staticClass: "price", attrs: { _hid: 71 } }, [
          _vm._v(_vm._s(_vm.goods.actualPrice), 72)
        ])
      ]),
      _c(
        "text",
              ...
              function(item, index, item_i2) {
                ...
                return _c(
                  "view",
                  {
                    ...
                    attrs: { _hid: 80, _fid: _fid, _fk: "index" },
                    on: {
                      click: function($event) {
                  ...
                  [
                    _c(
                      "view",
                      { staticClass: "con", attrs: { _hid: 81, _fid: _fid } },
                      [
                        _c(
                          "view",
                          {
                        ...
                        _c(
                          ...
                          [
                            _c(
                              ...
                              [_vm._v(_vm._s(item.discount), 87, _fid)]
                            ),
                            _c("text", { attrs: { _hid: 88, _fid: _fid } }, [
                              _vm._v("满" + _vm._s(item.min) + "可用", 89, _fid)
                            ])
                          ]
                        ),
                        _c("view", {
                    ...
                    _c(
                      "text",
                      { staticClass: "tips", attrs: { _hid: 92, _fid: _fid } },
                      [
                        _vm._v(
...
var _default = { data: function data() {return { maskState: false, //优惠券面板显示状态
    ...
    toggleMask: function toggleMask(id) {this.maskState = false;this.couponId = id;this.cartdata();}, numberChange: function numberChange(data) {this.number = data.number;}, changePayType: function changePayType(type) {this.payType = type;}, submit: function submit() {var _this3 = this;var submiturl = '/order/submit';uni.showLoading({ title: '正在加载' });_vmeitimeHttp.default.httppost(submiturl, { addressId: this.checkedAddress.id, cartId: this.cartId, couponId: this.couponId, grouponLinkId: 0, grouponRulesId: this.grouponRulesId, message: this.message }).then(function (res) {if (res.data.errno == 0) {var orderId = res.data.data.orderId;uni.setStorageSync('couponId', 0);_this3.paysub(orderId);} else {uni.redirectTo({ url: '/pages/order/order?state=1' });uni.showToast({ title: res.data.errmsg, icon: 'none' });}uni.hideLoading();}).catch(function (res) {});uni.hideLoading();}, paysub: function paysub(orderId) {// 调用后台支付接口
      uni.showLoading({ title: '正在加载' });var payurl = '/order/prepay';payurl = '/order/prepayDouyin';
...
//# sourceMappingURL=../../../.sourcemap/mp-alipay/pages/order/createOrder.js.map