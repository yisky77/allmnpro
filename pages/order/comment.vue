	  ...
	  <view class="post-comment">
	    ...
	    <!-- <view class="rater">
	      ...
	      <block v-for="(item, index) in stars" :key="index">
	        <image src="/static/category/icon_collect_checked.png" @tap="selectRater" v-if="item < star"></image>
	        <image src="/static/category/icon_collect.png" @tap="selectRater"  v-else></image>
	      </block>
		...
		methods: {
			chooseImage: function(e) {
			  ...
			  getOrderGoods: function() {
			    let that = this;
			    api.httpget('/order/goods?orderId='+this.orderId+'&goodsId='+this.valueId).then(function(res) {
			      if (res.data.errno === 0) {
