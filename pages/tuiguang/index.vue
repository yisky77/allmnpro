	...
	<view class="container">
		...
		<view class="introduce-section">
			...
			<button class="share-btn"  @click="share">
				立即分享<text class="yticon icon-you"></text>
			</button>
			<!-- #endif -->
	  ...
	  <view class="goods-attr" v-if="responsdata.attribute.length>0">
		...
		<share 
			ref="share" 
			:contentHeight="580" :sharedata="sharedata"
		></share>
		<auth></auth>
...
<script>
	...
	import share from '@/pages/product/share.vue';
	export default{
		components: {
			share, auth
		},
...
<style lang='scss'>
	...
	.gobrand{
		margin-left: 10px;paddiing:0 15upx;
